#include "LochExperienceDefinition.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(LochExperienceDefinition)

#define LOCTEXT_NAMESPACE "LochSystem"

ULochExperienceDefinition::ULochExperienceDefinition()
{
}

#if WITH_EDITOR
EDataValidationResult ULochExperienceDefinition::IsDataValid(FDataValidationContext& Context) const
{
