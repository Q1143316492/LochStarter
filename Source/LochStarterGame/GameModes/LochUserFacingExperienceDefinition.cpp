...
#include "LochUserFacingExperienceDefinition.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(LochUserFacingExperienceDefinition)

UCommonSession_HostSessionRequest* ULochUserFacingExperienceDefinition::CreateHostingRequest(const UObject* WorldContextObject) const
{
