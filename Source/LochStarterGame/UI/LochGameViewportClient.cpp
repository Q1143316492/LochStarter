...
#include "LochGameViewportClient.h"

#include "CommonUISettings.h"
#include "ICommonUIModule.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(LochGameViewportClient)
...
ULochGameViewportClient::ULochGameViewportClient()
	: Super(FObjectInitializer::Get())
{
}

void ULochGameViewportClient::Init(struct FWorldContext& WorldContext, UGameInstance* OwningGameInstance, bool bCreateNewAudioDevice)
{
