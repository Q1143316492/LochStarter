...
#include "LochGameplayRpcRegistrationComponent.generated.h"

#define UE_API LOCHSTARTERGAME_API

UCLASS(MinimalAPI)
class ULochGameplayRpcRegistrationComponent : public UExternalRpcRegistrationComponent
{
	GENERATED_BODY()
protected:
	static UE_API ULochGameplayRpcRegistrationComponent* ObjectInstance;

public:
	static UE_API ULochGameplayRpcRegistrationComponent* GetInstance();
