...
#include "LochDeveloperSettings.generated.h"
...
public:
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, config, Category=Loch, meta=(AllowedTypes="LochExperienceDefinition"))
	FPrimaryAssetId ExperienceOverride;

	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, config, Category=LochBots, meta=(InlineEditConditionToggle))
	bool bOverrideBotCount = false;

	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, config, Category=LochBots, meta=(EditCondition=bOverrideBotCount))
	int32 OverrideNumPlayerBotsToSpawn = 0;

	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, config, Category=LochBots)
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, config, Category=Loch)
	...
	*/
	UPROPERTY(config, EditAnywhere, Category = Loch, meta = (ConsoleVariable = "LochPC.ShouldAlwaysPlayForceFeedback"))
	...
	UPROPERTY(config, EditAnywhere, Category=Loch)
	TArray<FLochCheatToRun> CheatsToRun;
...
public:
	...
	LOCHSTARTERGAME_API void OnPlayInEditorStarted() const;
