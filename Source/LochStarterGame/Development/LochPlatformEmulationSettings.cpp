...
#include "LochPlatformEmulationSettings.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(LochPlatformEmulationSettings)

#define LOCTEXT_NAMESPACE "LochCheats"

ULochPlatformEmulationSettings::ULochPlatformEmulationSettings()
{
}

FName ULochPlatformEmulationSettings::GetCategoryName() const
{
	return FApp::GetProjectName();
}

FName ULochPlatformEmulationSettings::GetPretendBaseDeviceProfile() const
{
	return PretendBaseDeviceProfile;
}

FName ULochPlatformEmulationSettings::GetPretendPlatformName() const
{
	return PretendPlatform;
}

#if WITH_EDITOR
void ULochPlatformEmulationSettings::PostEditChangeProperty(FPropertyChangedEvent& PropertyChangedEvent)
{
...
void ULochPlatformEmulationSettings::PostReloadConfig(FProperty* PropertyThatWasLoaded)
{
...
void ULochPlatformEmulationSettings::PostInitProperties()
{
...
void ULochPlatformEmulationSettings::OnPlayInEditorStarted() const
{
...
void ULochPlatformEmulationSettings::ApplySettings()
{
...
void ULochPlatformEmulationSettings::ChangeActivePretendPlatform(FName NewPlatformName)
{
...
TArray<FName> ULochPlatformEmulationSettings::GetKnownPlatformIds() const
{
...
TArray<FName> ULochPlatformEmulationSettings::GetKnownDeviceProfiles() const
{
	TArray<FName> Results;
...
void ULochPlatformEmulationSettings::PickReasonableBaseDeviceProfile()
{
