...
#include "LochTextHotfixConfig.generated.h"
...
class ULochTextHotfixConfig : public UDeveloperSettings
{
	GENERATED_BODY()

public:
	ULochTextHotfixConfig(const FObjectInitializer& ObjectInitializer);
