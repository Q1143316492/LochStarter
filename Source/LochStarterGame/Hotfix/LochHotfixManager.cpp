...
#include UE_INLINE_GENERATED_CPP_BY_NAME(LochHotfixManager)

int32 ULochHotfixManager::GameHotfixCounter = 0;

ULochHotfixManager::ULochHotfixManager()
{
#if !UE_BUILD_SHIPPING
	OnScreenMessageHandle = FCoreDelegates::OnGetOnScreenMessages.AddUObject(this, &ULochHotfixManager::GetOnScreenMessages);
...
void ULochHotfixManager::Init()
{
	Super::Init();
}

void ULochHotfixManager::OnHotfixCompleted(EHotfixResult HotfixResult)
{
	...
	if (bHasPendingDeviceProfileHotfix)
	{
		...
		ULochSettingsLocal* GameSettings = ULochSettingsLocal::Get();
...
bool ULochHotfixManager::WantsHotfixProcessing(const FCloudFileHeader& FileHeader)
{
...
bool ULochHotfixManager::HotfixIniFile(const FString& FileName, const FString& IniData)
{
...
bool ULochHotfixManager::ApplyHotfixProcessing(const FCloudFileHeader& FileHeader)
{
...
bool ULochHotfixManager::ShouldWarnAboutMissingWhenPatchingFromIni(const FString& AssetPath) const
{
	return AssetPath.StartsWith(TEXT("/Engine/")) || AssetPath.StartsWith(TEXT("/Game/"));
}

void ULochHotfixManager::PatchAssetsFromIniFiles()
{
#if ENABLE_SHARED_MEMORY_TRACKER
...
void ULochHotfixManager::OnHotfixAvailablityCheck(const TArray<FCloudFileHeader>& PendingChangedFiles, const TArray<FCloudFileHeader>& PendingRemoveFiles)
{
...
#if !UE_BUILD_SHIPPING
void ULochHotfixManager::GetOnScreenMessages(TMultiMap<FCoreDelegates::EOnScreenMessageSeverity, FText>& OutMessages)
{
	// TODO Any messages/errors.
}
#endif // !UE_BUILD_SHIPPING

void ULochHotfixManager::RequestPatchAssetsFromIniFiles()
{
...
void ULochHotfixManager::StartHotfixProcess()
{
	if (GIsEditor)
	{
