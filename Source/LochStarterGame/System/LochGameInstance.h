...
#include "LochGameInstance.generated.h"
...
class ULochGameInstance : public UCommonGameInstance
{
	GENERATED_BODY()

public:

	UE_API ULochGameInstance(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());

    UE_API ALochPlayerController* GetPrimaryPlayerController() const;
