...
public class LochStarterGameTarget : TargetRules
{
	public LochStarterGameTarget(TargetInfo Target) : base(Target)
	{
	...
	internal static void ApplySharedLochStarterTargetSettings(TargetRules Target)
	{
		...
		if (Target.BuildEnvironment == TargetBuildEnvironment.Unique)
		{
			...
			LochStarterGameTarget.ConfigureGameFeaturePlugins(Target);
		}
		else
		{
			// !!!!!!!!!!!! WARNING !!!!!!!!!!!!!
